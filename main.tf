...
resource "aws_eks_cluster" "sai_eks" {
...
resource "aws_eks_node_group" "sai_nodes" {
  cluster_name    = aws_eks_cluster.sai_eks.name
  node_group_name = "sai-node-group"
